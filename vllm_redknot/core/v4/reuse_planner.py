# REDKNOT-CORE: portable source extraction; runtime integration is tracked separately.
from __future__ import annotations

from typing import Any, Mapping

from vllm_redknot.core.v4.config import RedKnotV4Config
from vllm_redknot.core.v4.types import (
    FallbackReason,
...
def validate_mla_off_plan(
    ...
    *,
    ...
    if restore and "merged_prefill_tokens" in plan:
        from vllm_redknot.core.v4.merged_prefill import (
